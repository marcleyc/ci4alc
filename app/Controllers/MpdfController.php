...
class MpdfController extends BaseController
{
    ...
    {
        // Dados dinâmicos para o PDF
        $data['titulo'] = 'Exemplo de PDF';
        $data['conteudo'] = 'Conteúdo dinâmico do PDF aqui...';

        // Carrega o view com os dados
        $html = view('mpdf/gerarpdf', $data);

        // Crie uma instância do mPDF
        $mpdf = new \Mpdf\Mpdf(['default_font' => 'utf-8']);

        // Adicione o conteúdo ao mPDF
        $mpdf->WriteHTML($html);
    ...
    {
        $data['nome'] = "VICTOR KOLTUNIK FRANÇA";
        $data['estcivil'] = "casado";
        ...
        $mpdf->SetHeader('<img src="base_url(assets/img/logo-50.png)" align="middle" width=200 >');
