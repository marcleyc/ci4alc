...
<div>  
   <h3 padding-top=25px margin-top=25px align="center">P R O C E S S O S</h3>
</div>  
...
<template>
  <v-data-table dense :headers="headers" :items="desserts" :search="search" sort-by="nome" class="elevation-1">
    ...
    <template v-slot:item.actions="{ item }">
      ...
      <v-btn small class="mr-2" :href="`<?php echo site_url('/recibo')?>/${item.idRec}`" target="_blank" > edit </v-btn>
    </template>
